...
export const eu = {
  ...
  projects: {
    ...
    softwareContext: 'Produktua, weba eta tresnak, non AA materiala den eta ez azal soila.',
    researchKicker: '— Adarra 02',
    researchTitle: 'Gizarte ikerketa',
    researchContext: 'Hiri-etnografia, landa-azterketa eta gizarte-ikerketa aplikatua.',
    branchSwitchLabel: 'Adar aldaketa',
