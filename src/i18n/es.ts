export const es = {
  ...
  projects: {
    ...
    softwareContext: 'Producto, web y utilidades donde la IA es materia, no envoltorio.',
    researchKicker: '— Rama 02',
    researchTitle: 'Investigación social',
    researchContext: 'Etnografía urbana, análisis de campo y sociología aplicada.',
    branchSwitchLabel: 'Cambio de rama',
