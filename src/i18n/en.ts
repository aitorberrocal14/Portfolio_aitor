export const en = {
  ...
  projects: {
    ...
    softwareContext: 'Product, web and tools where AI is the material, not the wrapper.',
    researchKicker: '— Branch 02',
    researchTitle: 'Social research',
    researchContext: 'Urban ethnography, field analysis and applied sociology.',
    branchSwitchLabel: 'Change of branch',
